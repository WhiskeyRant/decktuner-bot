...
export default [
    ...
    {
        question: `Tuning a deck can take a lot of time and effort. How much would you be willing to tip your tuner if they do a great job? *Tipping is not required, but it may help attract a tuner to your workshop if you offer a tip*` ,
        key: 'tip_amount',
    },
];
